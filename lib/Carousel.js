...
function Carousel(options) {
  ...
  this.options.impressHost = this.options.impressHost || DEFAULT_IMPRESS_HOST;
  this._impressHost = this.options.impressHost;

  this.options.impressFrontendMode = typeof this.options.impressFrontendMode == 'undefined' || this.options.impressFrontendMode;
...
Carousel.prototype = {
  ...
  _startRequest: function() {
    ...
    if (this._impressFrontend) {
      ...
      parsedHost = this._impressHost.split(':');
