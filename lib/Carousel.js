...
function Carousel(options) {
  options = options || {};
  options.impressHost = options.impressHost || DEFAULT_IMPRESS_HOST;
  options.impressFrontendMode = typeof options.impressFrontendMode == 'undefined' || options.impressFrontendMode;
